...
define(['angular', 'services/module-name'], function (angular, moduleName) {
    return angular.module(moduleName).factory('StateService', ["$state", function ($state) {
        ...
        var FeedStates = function () {
            ...
            data.navigateToDefineFeedPopulated = function (selectedTableName, selectedDataSource) {
                $state.go('define-feed-populated', {selectedTableName: selectedTableName, selectedDataSource: selectedDataSource});
            }
