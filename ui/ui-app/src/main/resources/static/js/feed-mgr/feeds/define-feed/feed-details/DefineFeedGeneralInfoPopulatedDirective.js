...
define(['angular', 'feed-mgr/feeds/define-feed/module-name'], function (angular, moduleName) {
    ...
    var directive = function () {
        return {
            ...
            require: ['thinkbigDefineFeedGeneralInfoPopulated', '^thinkbigStepper'],
            scope: {},
            controllerAs: 'vm',
            templateUrl: 'js/feed-mgr/feeds/define-feed/feed-details/define-feed-general-info.html',
            controller: "DefineFeedGeneralInfoPopulatedController",
    ...
    angular.module(moduleName).controller('DefineFeedGeneralInfoPopulatedController', ["$scope", "$log", "$http", "$mdToast", "RestUrlService", "FeedService", "CategoriesService", controller]);

    angular.module(moduleName)
        .directive('thinkbigDefineFeedGeneralInfoPopulated', directive);
