...
define(['angular','feed-mgr/feeds/define-feed/module-name'], function (angular,moduleName) {
    ...
    var directive = function() {
        return {
            ...
            require: ['thinkbigDefineFeedDetailsPopulated', '^thinkbigStepper'],
            scope: {},
            controllerAs: 'vm',
            templateUrl: 'js/feed-mgr/feeds/define-feed/feed-details/define-feed-details.html',
            controller: "DefineFeedDetailsPopulatedController",
    ...
    function DefineFeedDetailsPopulatedController($scope, $http, RestUrlService, FeedService, RegisterTemplateService, FeedInputProcessorOptionsFactory, BroadcastService, StepperService,
    ...
    angular.module(moduleName).controller('DefineFeedDetailsPopulatedController', ["$scope","$http","RestUrlService","FeedService","RegisterTemplateService","FeedInputProcessorOptionsFactory","BroadcastService","StepperService","FeedDetailsProcessorRenderingHelper",DefineFeedDetailsPopulatedController]);
    angular.module(moduleName).directive('thinkbigDefineFeedDetailsPopulated', directive);
});
